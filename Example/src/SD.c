...
static void xTaskRTConfig(void *pvParameters)
{
	...
	FullTime.time[RTC_TIMETYPE_MINUTE]  = 11;
	FullTime.time[RTC_TIMETYPE_HOUR]    = 19;
	FullTime.time[RTC_TIMETYPE_DAYOFMONTH]  = 8;
	FullTime.time[RTC_TIMETYPE_DAYOFWEEK]   = 6;
	FullTime.time[RTC_TIMETYPE_DAYOFYEAR]   = 340;
	FullTime.time[RTC_TIMETYPE_MONTH]   = 12;
